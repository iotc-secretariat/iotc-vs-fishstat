...
clus4 = cutree(TUNA_PHYLO, N_COL)

plot(TUNA_PHYLO, tip.color = colors[clus4], label.offset = 1, cex = 0.7)
plot(TUNA_PHYLO, type = "fan", tip.color = colors[clus4], label.offset = 1, cex = 0.7)

# Package ggdendro
ggdendrogram(TUNA_DEND)
