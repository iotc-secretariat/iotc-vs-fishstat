...
CL_SPECIES = fread("./inputs/data/CL_FI_SPECIES_GROUPS.csv", encoding = "UTF-8")[, .(SPECIES_CODE = `3A_Code`, SPECIES = Name_En, SPECIES_SCIENTIFIC = Scientific_Name, ISCSCAAP = ISSCAAP_Group_En)]
...
CAPTURE = CAPTURE_RAW[CL_COUNTRIES, on = c("COUNTRY.UN_CODE" = "UN_CODE"), nomatch = 0][CL_SPECIES, on = c("SPECIES.ALPHA_3_CODE" = "SPECIES_CODE"), nomatch = 0][CL_AREAS, on = c("AREA.CODE" = "FISHING_GROUND_CODE"), nomatch = 0][CL_UNITS, on = c("MEASURE" = "MEASUREMENT_CODE"), nomatch = 0]

setnames(CAPTURE, old = c("COUNTRY.UN_CODE", "SPECIES.ALPHA_3_CODE", "AREA.CODE"), new = c("COUNTRY_CODE", "SPECIES_CODE", "FISHING_GROUND_CODE"))

NC_FAO = CAPTURE[ISCSCAAP == "Tunas, bonitos, billfishes"]
